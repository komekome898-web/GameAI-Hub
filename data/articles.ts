...
export type ArticleLink = {
  ...
  label: string;
  reason: string;
  kind: "article" | "guide" | "tool" | "compare" | "reference";
};
export type ArticleSource = {
  label: string;
  url: string;
  kind: "primary" | "first-hand";
  verifiedAt: string;
};
export type ArticleRecord = {
  ...
  projectCta: { label: string; description: string; placement: "article_end" };
  promotions: readonly {
    serviceSlug: "meshy" | "elevenlabs";
...
export const articles = [
  {
    ...
    sources: [
      ...
      {
        label: "GitHub Docs: Asking GitHub Copilot questions in GitHub",
        url: "https://docs.github.com/en/copilot/using-github-copilot/asking-github-copilot-questions-in-github",
        kind: "primary",
        verifiedAt: "2026-09-04",
      },
      {
        label: "GitHub Docs: What is GitHub Pages?",
    ...
    related: [
      ...
      },
      {
        ...
        label: "GitHub Copilotの確認情報",
        reason: "Copilotの用途と公式根拠を確認する",
        kind: "tool",
      },
      {
        href: "/methodology/",
    ...
    projectCta: {
      label: "元のゲーム制作taskへ戻る",
      description:
        "新しいProjectを作らず、開いていたタブへ戻って同じゲームのindex.html制作を続けます。",
  ...
  },
  {
    ...
    sources: [
      ...
      {
        label: "Chrome DevTools: Console overview",
    ...
    related: [
      {
        href: "/articles/before-asking-ai-build-game/",
        label: "AIへ頼む前に決める5項目",
        reason: "別のゲーム案でも最初の範囲と完了条件を決める",
        kind: "article",
      },
      {
        href: "/guides/ai-2d-rpg-workflow/",
        label: "AIで2D RPGを作る制作フロー",
        reason: "1画面の試作から長い制作工程へ広げる順序を確認する",
        kind: "guide",
      },
      {
        href: "/articles/github-beginner-game-development/",
        label: "GitHubを初めて使う人の保存ガイド",
        reason: "Copilotのアカウント準備とindex.htmlの保存方法を確認する",
        kind: "article",
      },
    ],
    projectCta: {
      label: "自分のブラウザゲームを「最初の1プレイ」に分ける",
      description:
        "条件を確認し、今作るもの・作らないもの・完了条件を固定して、1つのindex.htmlを動かす作業へ進みます。",
      placement: "article_end",
    },
    promotions: [],
  },
  {
    ...
    related: [
      {
        ...
        label: "AIの正しい使い方",
        reason: "失敗を防ぐ具体的な指示と検証の型へ進む",
        kind: "article",
      },
      {
        href: "/guides/codex-game-development-brief/",
        label: "Codexへ渡す実装ブリーフ",
        reason: "考え方を検証可能な実装タスクへ変える",
        kind: "guide",
      },
      {
        href: "/methodology/",
    ...
    projectCta: {
      ...
      description: "丸投げせず、成果物と完了条件に分けた最初の作業を作ります。",
      placement: "article_end",
    },
    promotions: [],
  },
  {
    ...
    sources: [
      {
        label: "OpenAI: GPT-5.6 in ChatGPT",
    ...
    related: [
      {
        href: "/articles/ai-fantasy/",
        label: "AIに幻想を抱くあなたへ",
        reason: "AIへ任せる範囲と人が確認する範囲を整理する",
        kind: "article",
      },
      {
        href: "/guides/codex-game-development-brief/",
        label: "Codexへ渡す実装ブリーフ",
        reason: "目的・制約・完了条件を実装単位へ落とす",
        kind: "guide",
      },
      {
        href: "/tools/",
        label: "成果物からAIツールを探す",
        reason: "必要な成果物が決まった後に公式根拠を確認する",
        kind: "tool",
      },
    ],
    projectCta: {
      label: "自分のゲームで試す最初の作業を作る",
      description:
        "目的、制約、成果物、完了条件をゲーム案に合わせて具体化します。",
      placement: "article_end",
    },
    promotions: [],
  },
    ...
    related: [
      {
        href: "/articles/ai-fantasy/",
        label: "AIに幻想を抱くあなたへ",
        reason: "AIへ期待しすぎると何が起きるか、実際の失敗例から確認する",
        kind: "article",
      },
      {
        href: "/articles/ai-usage-guide/",
        label: "AIの正しい使い方",
        reason: "大きな依頼を目的・制約・完了条件へ分ける具体的な型へ進む",
        kind: "article",
      },
      {
        href: "/guides/ai-2d-rpg-workflow/",
        label: "AIで2D RPGを作る制作フロー",
        reason: "小さな成果物を積み上げる実際のゲーム制作順へ進む",
        kind: "guide",
      },
    ],
    projectCta: {
      label: "自分のゲームを「最初の1作業」に分ける",
      description:
        "作りたいゲームから、今作る成果物・使うAI・完了条件までを1ステップに絞ります。",
      placement: "article_end",
    },
    promotions: [],
  },
    ...
    related: [
      {
        ...
        reason: "依頼を大きくしすぎたときに起こる問題を先に確認する",
        kind: "article",
      },
      {
        href: "/articles/ai-usage-guide/",
        label: "AIの正しい使い方",
        reason: "目的・制約・完了条件を具体的な指示へ変える",
        kind: "article",
      },
      {
        href: "/guides/ai-2d-rpg-workflow/",
        label: "AIで2D RPGを作る制作フロー",
        reason: "小さな成果物を積み上げる順序の例を見る",
        kind: "guide",
      },
    ],
    projectCta: {
      label: "自分のゲームの最初の1作業を決める",
      description:
        "ゲーム案から、最初の成果物・使うAI・完了条件を具体化します。",
      placement: "article_end",
    },
    promotions: [],
  },
  {
    ...
    related: [
      {
        href: "/articles/ai-fantasy/",
        label: "AIに幻想を抱くあなたへ",
        reason: "AIの自己評価と実画面の差が起きた失敗例を読む",
        kind: "article",
      },
      {
        href: "/articles/ai-delegation-trap/",
        label: "AIにゲーム開発を丸投げすると、なぜ途中で詰むのか",
        reason: "完成判定以前に作業を小さく分ける理由を確認する",
        kind: "article",
      },
      {
        href: "/methodology/",
    ...
    projectCta: {
      label: "成果物と完了条件から最初の作業を作る",
      description:
        "AIの自己申告ではなく、自分で確認できる完了条件を持つ制作手順に変えます。",
      placement: "article_end",
    },
    promotions: [],
  },
  {
    ...
    related: [
      {
        href: "/articles/before-asking-ai-build-game/",
        label: "AIに「ゲームを作って」と頼む前に決めるべき5つのこと",
        reason: "ツールを選ぶ前に決める成果物と完了条件を整理する",
        kind: "article",
      },
      {
        href: "/articles/ai-usage-guide/",
        label: "AIの正しい使い方",
        reason: "AIへ任せる役割を作業単位で考える",
        kind: "article",
      },
      {
        href: "/tools/",
        label: "成果物からAIツールを探す",
        reason: "必要な成果物が決まった段階で候補を確認する",
        kind: "tool",
      },
    ],
    projectCta: {
      label: "先に作るものを決めてからAIを選ぶ",
      description:
        "あなたのゲームで今必要な成果物を特定し、その作業に合うAI候補まで絞ります。",
      placement: "article_end",
    },
    promotions: [],
  },
    ...
    related: [
      {
        href: "/articles/ai-delegation-trap/",
        label: "AIにゲーム開発を丸投げすると、なぜ途中で詰むのか",
        reason: "大きな依頼を小さな制作単位へ分ける理由を確認する",
        kind: "article",
      },
      {
        href: "/articles/before-asking-ai-build-game/",
        label: "AIに「ゲームを作って」と頼む前に決めるべき5つのこと",
        reason: "最初の成果物と完了条件を具体的に決める",
        kind: "article",
      },
      {
        href: "/guides/ai-2d-rpg-workflow/",
        label: "AIで2D RPGを作る制作フロー",
        reason: "小さな成功を次の機能へ積み上げる例を見る",
        kind: "guide",
      },
    ],
    projectCta: {
      label: "最初の「動いた」を作る1作業を決める",
      description:
        "ゲーム全体ではなく、最初に確認できる小さな成功までの手順を作ります。",
      placement: "article_end",
    },
    promotions: [],
  },
  ...
  for (const a of records) {
    ...
    for (const [field, date] of [
      ...
      if (
        ...
        errors.push(`invalid ${field}: ${a.slug}`);
    if (a.updatedAt < a.publishedAt)
      errors.push(`updatedAt before publishedAt: ${a.slug}`);
    if (
      a.publicationStatus === "published" &&
      (!a.projectCta || !a.editorialNote || a.related.length === 0)
    )
      errors.push(`incomplete published article: ${a.slug}`);
    if (
      a.publicationStatus === "published" &&
      (a.category === "tool" || a.category === "comparison") &&
      (!a.lastVerifiedAt || a.sources.length === 0)
    )
      errors.push(`unverified factual article: ${a.slug}`);
    const sourceUrls = new Set<string>();
    for (const source of a.sources) {
      try {
        if (new URL(source.url).protocol !== "https:")
          errors.push(`non-https source: ${a.slug}`);
      } catch {
        errors.push(`invalid source: ${a.slug}`);
      }
      if (sourceUrls.has(source.url))
        errors.push(`duplicate source: ${a.slug}`);
    ...
    for (const link of a.related) {
      if (
        ...
        errors.push(`invalid related link: ${a.slug}`);
      if (relatedHrefs.has(link.href))
        errors.push(`duplicate related link: ${a.slug}`);
      relatedHrefs.add(link.href);
      const match = link.href.match(/^\/articles\/([^/]+)\/?$/);
      if (match && !publishedSlugs.has(match[1]))
        errors.push(`related article is not published: ${a.slug}`);
    }
    for (const promotion of a.promotions)
      if (!promotion.context.trim())
        errors.push(`promotion without production rationale: ${a.slug}`);
  }
  return errors;
}
...
export function articlePath(article: ArticleRecord) {
  return `/articles/${article.slug}/`;
}
export function articleMetadata(article: ArticleRecord): Metadata {
  return {
    title: article.title,
