...
- Current: final GitHub handoff
- Remaining: open one Slice 0 PR against `main`; Slice 1 must retain these contracts while introducing foundations/intrinsic-size safety
