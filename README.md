...
Productionは **https://game-ai-hub.vercel.app** で稼働しており、`main`がProduction Branchである。このURLを唯一の本番originとしてcanonical、`og:url`、sitemap、robotsに使用する。このアプリはNext.jsの静的exportで、DBやNode.jsランタイムを必要としない。
