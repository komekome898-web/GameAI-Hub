...
| P0 | Vercel本番設定 | Project SettingsでProduction Branchが **main**、Production環境の`NEXT_PUBLIC_SITE_URL`が`https://game-ai-hub.vercel.app`であることを確認し、mainをDeployする。 |
| P0 | 公開URL確認 | `docs/DEPLOYMENT.md`の公開後QAを本番で実施し、8件すべてのtool detailを含む結果を記録する。 |
