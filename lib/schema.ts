...
export const serviceSchema = z.object({
  ...
  officialUrl:z.url(), affiliateUrl:z.url().nullable(), affiliateAvailable:z.enum(['yes','no','unknown']),
  ...
  sources:z.array(z.object({label:z.string(),url:z.url(),type:z.enum(['official','terms','pricing','docs'])})).min(1)
});
